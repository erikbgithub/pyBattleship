...
class Game:
    def __init__(self, func_distrib, solver, referee, width=BOARD_SIZE, height=BOARD_SIZE, sym_empty=SYM_EMPTY,
                 sym_hit=SYM_HIT, sym_miss=SYM_MISS, sym_unknown=SYM_UNKNOWN, start_ships=DEFAULT_SHIPS,
                 state=STATE_START):
        ...
        self.state = {'name': state, 'turn': 0, 'width': width, 'height': height, 'start_ships': start_ships,
                      'dead_ships': []}
